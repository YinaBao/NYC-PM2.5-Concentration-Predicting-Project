---
title: "DATS6101_Project2"
author: "Yina Bao, Li Du, Tushara Ekanayake, Shilpa Rajbhandari"
...
```{r timeseries, echo=FALSE, results='hide',fig.keep='all'}
df <- training
pm_time <- melt(df)
...
```{r hist,echo=FALSE,results='hide',fig.keep='all'}
